...
Phase 1–2 的 Web 工作台：Project 创建、个人文献库、Project 收录管理、PDF 上传与内容哈希自动复用、Run 进度 SSE 跟随与取消、Element/PDF 来源预览，以及整个 Project/单篇/多篇范围的带引用 RAG 对话。
...
npm run test:e2e # 隔离 Compose + API/Worker + Chromium 的 Phase 1–2 完整闭环
```
