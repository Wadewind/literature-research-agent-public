...
[Phase 0：项目基线与技术验证](phases/phase-00-project-baseline.md)和 [Phase 1：Project、个人文献库与可靠异步导入](phases/phase-01-project-library-ingestion.md)已经完成。Phase 1 已通过隔离 Compose Smoke、故障恢复测试和 Playwright E2E 验收；当前进行的是 [Phase 2：有引用的 RAG 问答](phases/phase-02-cited-rag-qa.md)（切片 1 资源管理边界已完成）。
